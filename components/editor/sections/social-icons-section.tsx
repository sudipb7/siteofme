...
import { SocialIconInput, socialIconSchema } from "@/lib/schemas";
import { EditorState, SocialIcon } from "@/hooks/stores/editor";
import { PLATFORM_ICONS, SOCIAL_PLATFORMS } from "@/lib/constants/site";
